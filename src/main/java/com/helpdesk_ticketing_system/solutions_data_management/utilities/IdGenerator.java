...
class IdGenerator
{
    private final String SOLUTION_ID_PREFIX;
    ...
    public IdGenerator(
            ...
            Calendar calendar,
            Random random,
            Integer randomNumberRange, @Qualifier("digitsToExtract") Integer numOfDigitsToExtractFromP
    ) {
        SOLUTION_ID_PREFIX = solutionIdPrefix;
    ...
    public String generateId()
    {
        ...
        AtomicReference<StringBuilder> issueID = new AtomicReference<>(new StringBuilder(SOLUTION_ID_PREFIX));
        issueID.get()
